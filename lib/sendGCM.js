...
const sendGCM = (regIds, data, settings) => {
  ...
  const notification = {
    ...
    // Android
    mutable_content: data.mutableContent // iOS
  ...
  let chunk = 0; // Split in 1.000 chunks, see https://developers.google.com/cloud-messaging/http-server-ref#table1
